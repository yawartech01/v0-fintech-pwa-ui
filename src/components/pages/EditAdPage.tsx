  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold">Edit Sell Ad</h1>
      </div>
        ...
        <CardContent className="p-4">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-bold text-lg">{formatNumber(ad.amountTotalUsdt)} USDT</p>
            </div>
            <div>
              <p className="text-muted-foreground">Remaining</p>
              <p className="font-bold text-lg">{formatNumber(ad.amountRemainingUsdt)} USDT</p>
            </div>
          </div>
